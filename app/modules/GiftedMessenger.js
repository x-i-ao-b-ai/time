  ...
  getDefaultProps() {
    ...
    renderErrorButton(rowData = {}, rowID = null) {
      if (rowData.status === 'ErrorButton') {
        return ( < ErrorButton onErrorButtonPress = {
            this.props.onErrorButtonPress
          }
          rowData = {
            rowData
          }
    ...
    renderAnimatedView() {
      if (this.props.inverted === true) {
        return ( < Animated.View style = {
          ...
          renderFooter = {
            this.renderLoadEarlierMessages
          }
          style = {
            this.styles.listView
          }

          renderScrollComponent = {
            props => < InvertibleScrollView {...props
            }
            inverted / >
          }
  ...
  getInitialState() {
    ...
    render() {
      if (this.state.isLoading === true) {
        return ( < View style = {
            [this.props.styles.errorButtonContainer, {
